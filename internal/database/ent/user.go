...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUsername, user.FieldPassword, user.FieldEmail, user.FieldRole:
...
func (_m *User) QueryBlogs() *BlogQuery {
	return NewUserClient(_m.config).QueryBlogs(_m)
}
