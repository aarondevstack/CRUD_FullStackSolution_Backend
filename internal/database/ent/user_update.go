...
func (_u *UserUpdate) AddBlogIDs(ids ...int) *UserUpdate {
	_u.mutation.AddBlogIDs(ids...)
	return _u
}

// AddBlogs adds the "blogs" edges to the Blog entity.
func (_u *UserUpdate) AddBlogs(v ...*Blog) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddBlogIDs adds the "blogs" edge to the Blog entity by IDs.
func (_u *UserUpdateOne) AddBlogIDs(ids ...int) *UserUpdateOne {
	_u.mutation.AddBlogIDs(ids...)
	return _u
}

// AddBlogs adds the "blogs" edges to the Blog entity.
func (_u *UserUpdateOne) AddBlogs(v ...*Blog) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearBlogs clears all "blogs" edges to the Blog entity.
func (_u *UserUpdateOne) ClearBlogs() *UserUpdateOne {
	_u.mutation.ClearBlogs()
	return _u
}

// RemoveBlogIDs removes the "blogs" edge to Blog entities by IDs.
func (_u *UserUpdateOne) RemoveBlogIDs(ids ...int) *UserUpdateOne {
	_u.mutation.RemoveBlogIDs(ids...)
	return _u
}

// RemoveBlogs removes "blogs" edges to Blog entities.
func (_u *UserUpdateOne) RemoveBlogs(v ...*Blog) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
